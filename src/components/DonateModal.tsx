      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 pointer-events-none">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col cursor-grab active:cursor-grabbing pointer-events-auto"
          >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 min-h-full">
                ...
                <div className="p-6 md:p-8 bg-emerald-50 flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl font-black tracking-tight text-zinc-900">{t('support_me')}</h2>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-sm md:text-base">{t('contact_facebook')}</span>
                      </div>
                ...
                <div className="p-6 md:p-8 flex flex-col items-center justify-center gap-8 bg-white border-t md:border-t-0 md:border-l border-zinc-100">
                  <div className="text-center w-full max-w-[200px]">
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">{t('scan_bidv')}</p>
                  ...
                  <div className="text-center w-full max-w-[200px]">
                    <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">{t('scan_momo')}</p>
                    <div className="relative group inline-block">
