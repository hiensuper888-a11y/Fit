...
import { ShieldCheck, BookOpen, FlaskConical, Zap, Scale } from 'lucide-react';

export const WheyInfo: React.FC = () => {
  return (
    <div className="py-12 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-4xl font-black text-zinc-900 tracking-tight mb-8">Whey Protein: Khoa học & Công nghệ</h1>
      ...
      <div className="space-y-12">
        <section className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl font-bold">Công nghệ & Quy trình sản xuất</h2>
          </div>
        ...
        <section className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl font-bold">Tác dụng & Lợi ích</h2>
          </div>
        ...
        <section className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl font-bold">Whey vs. Thức ăn tự nhiên</h2>
          </div>
